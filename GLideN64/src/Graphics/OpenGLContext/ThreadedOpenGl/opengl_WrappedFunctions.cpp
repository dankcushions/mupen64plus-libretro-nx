...
namespace opengl {
	...
	std::vector<char> GlDrawArraysUnbufferedCommand::m_attribsData(12 * 1024 * 1024, 0);
	std::vector<char> GlDrawElementsUnbufferedCommand::m_attribsData(12 * 1024 * 1024, 0);
